<!--
Derived artifact.
Source manuscript: 03-outputs/manuscript/IRL_Patterns_Manuscript_Only.md
Enhancement notes: 03-outputs/manuscript/irloop-docs-enhancements.md
Strategy: append enhancement blocks as a proposed Appendix for review (does not overwrite core manuscript text).
-->
...
# Appendix: Proposed Insertions From irloop.org Docs (Draft)

The blocks below are extracted from `irloop-docs-enhancements.md` and formatted as a manuscript-friendly appendix. They are intended as candidate insertions (or a basis for rewriting) rather than normative final text.
