...
- **Plan document** (`plan.md`): Human-editable intent and constraints
...
```
project/
├── plan.md                    # Your control surface: intent, constraints, acceptance criteria
...
4. **Start with `plan.md`**: Write your first plan specifying what you want to accomplish, any constraints, and how you'll know when it's done. See `example_plans/irl-basic-template.md` for a template.
