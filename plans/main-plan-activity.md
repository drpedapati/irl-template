...
- 2026-02-08: Iterated on loop toy per feedback — enlarged all labels (20px/15px/14px nodes, 15px paths), replaced "ARTIFACTS" with "FILES" for non-technical clarity, bigger file rectangles (24x28), larger nodes (0.15), tighter canvas (5:2.5), updated captions/text to avoid jargon, fixed HTML ellipsis; confirmed explainer skill unchanged (still v1.5.0 @ 2849c0a); validated both pages serve.
